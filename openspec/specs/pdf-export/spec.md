...
| PDF-10 | Live report export entry | New | MUST | Logged-in `/report` with persisted id shows "Exportar PDF" → `/api/report/{id}/pdf`; no id → no entry; anonymous → signup CTA; route unchanged |
