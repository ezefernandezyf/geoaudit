...
- [ ] U4.1 `app/dashboard/page.tsx`: runner bar (input + "Run Audit" dentro + user chip) (DSH-8) + test
- [ ] U4.2 grid 12-col: Aggregate `col-4` + Trend `col-8` misma fila, 12 barras CSS puras (DSH-9) + test
- [ ] U4.3 `src/dashboard/audit-history-table.tsx`: header bar + chip Multi-Page + refresh + fila "SCANNING..." (DSH-10,11) + test
- [ ] U4.4 restyle Gemini de `src/dashboard/*` (aggregate-hero, score-trend, share-modal, billing-cta, empty-state) + test
